<template>
  ...
  <nav class="userNav sticky-top">
    <div class="container g-0">
      ...
      <ul class="product-link d-flex flex-column align-items-center justify-content-center list-unstyled"
        :class="{'d-none':bar}"
      >
        <li class="pb-3" v-for="tab in tabs" :key="tab">
          <router-link :to="tab.url">{{tab.title}}</router-link>
        </li>
      </ul>
    </div>
  </nav>
